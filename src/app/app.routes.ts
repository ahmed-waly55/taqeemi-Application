...
export const routes: Routes = [
  ...
  {path:"rewards" , title: "Rewards", loadComponent: ()=> import("./layout/dashboard/pages/rewards/rewards.component").then(m=>m.RewardsComponent)},
  ...
  {path:"leaderboard" , title: "Leaderboard", loadComponent: ()=> import("./layout/dashboard/pages/leaderboard/leaderboard.component").then(m=>m.LeaderboardComponent)},
